...
@Service
@Profile("Pro")
public class BasketProImpl implements Basket {
    ...
    public BasketProImpl(List<Product> productList) {
    ...
    public void showProductList() {
        ...
        BigDecimal discountRate = BigDecimal.valueOf(1 - discountValue / 100);
        ...
        BigDecimal totalPriceWithTaxAndDiscount = totalPriceWithTax.multiply(discountRate).setScale(2, RoundingMode.HALF_EVEN);
        System.out.println("Wartość z VAT i rabatem:\t\t" + totalPriceWithTaxAndDiscount + " zł");
    }
}
